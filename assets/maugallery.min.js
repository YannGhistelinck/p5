...
let index=0,next=null;$(imagesCollection).each(function(i){if($(activeImage).attr("src")===$(this).attr("src")){index=i}});if(index==0){next=imagesCollection[imagesCollection.length-1]}else{next=imagesCollection[index-1]}
...
let index=0,next=null;$(imagesCollection).each(function(i){if($(activeImage).attr("src")===$(this).attr("src")){index=i}});if(index==imagesCollection.length-1){next=imagesCollection[0]}else{next=imagesCollection[index+1]}
